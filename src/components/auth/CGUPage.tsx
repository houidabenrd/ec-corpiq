  ...
  return (
    ...
    >
      <div className="space-y-6">
        <div className="flex items-center gap-3 p-4 bg-corpiq-blue-50 rounded-xl border border-corpiq-blue-100">
          <Shield size={20} className="text-corpiq-blue flex-shrink-0" />
          <p className="text-sm text-corpiq-blue font-medium">
        ...
        <div className="border border-gray-200 rounded-2xl overflow-hidden">
          <div className="bg-gray-50 px-4 py-3 border-b border-gray-100 flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-gray-700">CGU — Version 2.1</span>
            <span className="text-xs text-gray-400 ml-auto">Mise à jour : 15 janvier 2026</span>
          </div>
          <div className="p-5 h-64 overflow-y-auto text-sm text-gray-600 space-y-4 leading-relaxed">
        ...
        <label className="flex items-start gap-3 cursor-pointer select-none group p-3.5 bg-gray-50 rounded-xl border border-gray-100 hover:bg-gray-100/80 transition-all">
          <input
            type="checkbox"
            checked={accepted}
