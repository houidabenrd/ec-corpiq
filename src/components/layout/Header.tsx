          ...
          <div className="relative ml-1">
            ...
            {avatarOpen && (
              <>
                ...
                <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-2xl shadow-dropdown border border-gray-100 overflow-hidden z-50 animate-scale-in">
                  ...
                  <div className="py-1.5 px-1.5">
                    <button
                      ...
                      className={clsx(
                        'w-full flex items-center gap-3 px-3 py-2 text-sm rounded-xl transition-all',
                        location.pathname === '/profile' ? 'text-corpiq-blue bg-corpiq-blue-50 font-medium' : 'text-gray-700 hover:bg-gray-50'
                      )}
                    >
                    ...
                    <button
                      onClick={() => navTo('/profile')}
                      className="w-full flex items-center gap-3 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-xl transition-all"
                    >
