...
const personas = [
  ...
  },
  {
    ...
    title: 'Délégué',
    description: 'Utilisateur rattaché à une organisation, mais pas le membre principal.',
    details: [
      'Menu complet comme le membre actif',
      'Profil : organisation en lecture seule',
      'Message "Seul le membre principal peut modifier"',
      'Pas de section informations bancaires',
      'Peut modifier ses infos personnelles et préférences',
    ],
  },
  {
    presetIndex: 3,
    ...
    details: [
      ...
      'Menu identique au membre actif',
  ...
  },
  {
    ...
    details: [
      ...
      'Menu restreint (comme non-membre)',
  ...
  },
  {
    ...
    details: [
      ...
      'Menu restreint, services premium masqués',
      'CTA "Renouveler maintenant"',
      'Profil : facturation visible pour mise à jour',
    ],
  },
...
export function PrototypeHub() {
  ...
  function handleSelectPersona(presetIndex: number, goToDashboard: boolean) {
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-corpiq-blue bg-corpiq-blue-50 rounded-lg hover:bg-corpiq-blue-100 transition-colors"
            >
              <LogIn size={16} />
              Voir la connexion
            </button>
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-corpiq-blue rounded-lg hover:bg-corpiq-blue-light transition-colors"
            >
              <UserPlus size={16} />
              Voir l'inscription
            </button>
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-2 max-w-2xl mx-auto">
            Chaque carte représente un type d'utilisateur. Cliquez pour voir le tableau de bord,
            le menu de navigation et le profil adaptés à ce cas.
          </p>
        </div>
        ...
        <div className="mb-8 bg-white rounded-xl border border-gray-200 p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
              <span className="w-7 h-7 bg-corpiq-blue text-white rounded-lg flex items-center justify-center text-xs font-bold flex-shrink-0">1</span>
              <div>
                <p className="text-sm font-medium text-gray-900">Inscription & Connexion</p>
                <p className="text-xs text-gray-500">6 workflows : inscription membre/non-membre, connexion classique/SSO, mot de passe oublié, CGU</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
              <span className="w-7 h-7 bg-corpiq-blue text-white rounded-lg flex items-center justify-center text-xs font-bold flex-shrink-0">2</span>
              <div>
                <p className="text-sm font-medium text-gray-900">Menu de navigation</p>
                <p className="text-xs text-gray-500">5 scénarios : non-membre, membre actif, en renouvellement, expiré/grâce, inactif</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
              <span className="w-7 h-7 bg-corpiq-blue text-white rounded-lg flex items-center justify-center text-xs font-bold flex-shrink-0">3</span>
              <div>
                <p className="text-sm font-medium text-gray-900">Profil</p>
                <p className="text-xs text-gray-500">12 scénarios : contact, sécurité, préférences, facturation selon le rôle</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {personas.map((p) => (
            <div
              key={p.presetIndex}
              className={`bg-white rounded-xl border-2 ${p.border} transition-all hover:shadow-lg group`}
            >
              ...
              <div className="p-5">
                ...
                <button
                  onClick={() => handleSelectPersona(p.presetIndex, true)}
                  className={`w-full flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-medium text-white bg-gradient-to-r ${p.color} hover:opacity-90 transition-opacity`}
                >
                  Voir l'expérience
                  <ArrowRight size={16} />
                </button>
